...
export const VARYLO = {
  ...
  planes: {
    titulo: "Planes simples, sin permanencia",
    subtitulo: "Cancela cuando quieras. Sin costos de setup ocultos.",
    items: [
      {
        nombre: "Starter",
        precio: "$29",
        ...
        descripcion: "Para empezar a automatizar WhatsApp.",
        incluye: [
          "1 canal (WhatsApp)",
          "Hasta 3 agentes",
          "Agente de IA",
      ...
      },
      {
        ...
        setup: "Sin costo de setup",
        destacado: true,
        descripcion: "El más elegido por equipos que venden.",
        incluye: [
      ...
      },
      {
        ...
        incluye: [
          "Todo lo de Pro",
          "Canales e integraciones a medida",
